...
def main(page: ft.Page):
    ...
    # --- ИЗМЕНЕННЫЙ РАЗДЕЛ НАСТРОЕК (ИСПРАВЛЕНО) ---
    settings_view = ft.Column([
        ...
        ft.Text("Версия движка: 2.3 ALBERT", color="grey", size=12)
    ], visible=False)
